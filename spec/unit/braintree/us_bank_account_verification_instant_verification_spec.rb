...
describe Braintree::UsBankAccountVerification do
  describe "VerificationMethod" do
    it "includes InstantVerification" do
  ...
  describe "verification with instant verification method" do
    it "parses verification with instant_verification method" do
      xml = <<-XML
